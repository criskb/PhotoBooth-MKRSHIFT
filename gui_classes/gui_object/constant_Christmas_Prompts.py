...
dico_styles = {
    "clay": 'Christmas card, winter theme where you Change the style to Textured stop-motion claymation with visible fingerprints, tool marks, and matte surfaces. Background: {{Whimsical|Cozy|Fun|} {Clay|Cardboard|Yarn|Fabric} {Castle|Village|Forest|Landscape|City}} environment sculpted from clay, cardboard, balsa wood, felt, and miniature props. Clothes: {forest ranger|fantasy|royal guard|white knight|ruffled|Fairy|Queen|king} attire crafted from **sculpted polymer clay, fabric scraps, and hand-painted details** (e.g., stitched seams, visible glue). Text: {Speech bubble saying {"Happy Holiday!!"|"Merry Christmas!"}|fancy banner saying "God Jul!"|fancy large Sign saying "God Jul!"} made of clay letters, cardstock, or wire-reinforced paper. Retain subject\'s identity, proportions, looks, and gender. Big googly eyes or hand-sculpted glass eyes. Soft directional lighting with subtle shadows. Slight focus imperfections. Render in tactile, handmade claymation style.',
    "comic": 'Christmas card, winter theme where you change the style to {art nouveau comic decorative elements with a vibrant and bustling metropolis in the background|retro comic|hyper realistic anime|retro anime|colored manga|western cartoon} style and background to {high fantasy glowing landscape and castles with intricate elements|rpg dungeon|fantasy {cafe|forest|throne room|ball room} with cute mosnters floating in the background} environment and change the clothes to {game styled intricate clothes|tactical rpg armour| futuristic high fantasy {armour|intricate dress|medieval clothes}| medieval armour|epic and futuristic heroic costume, elegant lines, floral patterns}, add text in a large font {"Happy Holiday!!"|"Merry Christmas!"} in a {speech bubble|fancy banner behind subject|grafitti|sign in the background}, retain subjects identity and porportions and look.',
    "oil paint": 'Christmas card, winter theme where you Change the style to Textured oil {Realism|Impressionism|Expressionism|Abstract|Surrealism} painting with visible brushstrokes, impasto technique, and rich varnished surfaces. Background: {{Epic|Cool|Fun|relaxed}  {Castle|Village|Forest|Landscape|City}} environment rendered in thick impasto, palette knife textures, and visible canvas weave. Clothes: {forest ranger|fantasy|royal guard|white knight|ruffled|Fairy|Queen|king} attire depicted with heavy pigment application, visible brushwork on fabrics, and chiaroscuro lighting (e.g., deep folds, satin highlights). Retain subject\'s identity, proportions, looks, and gender. Highly detailed, light-catching eyes with wet-on-wet blending. Soft Rembrandt lighting with dramatic shadows. Slight canvas texture visible. Render in traditional oil painting style with rich, saturated pigments and subtle varnish glow. Text saying Merry Christmas!, ugly christmas colors',
    "tvibit": 'Christmas card, winter theme where you Edit the image remove wrinkles, smooth skin, de-aged, same facial structure and ethnicity, smooth youthful skin, confident relaxed expression, 90s, 1990s Polaroid aesthetic, Kodak Ultramax tones, timestamp (\'95 08 22), subtle grain, poster wall, slight motion blur for candid realism, authentic analog imperfections, (retain skin tone and ethnicity:1.5), , christmas tree, edit background to cozy christmas, santa outfit',
    "cyberpunk": 'Christmas card, winter theme where you change the style to cyberpunk with holographic glitches,  Background: {{Dystopic|Neon|grid|spaceship} {City|spaceport|space|interior}} environment Clothes: {forest ranger|fantasy|royal guard|white knight|ruffled|Fairy|Queen|king} attire redesigned as tech-wear with augmented reality overlays Text: {Hologram Speech bubble saying {"Neerds!!"|"Game on!"|"Kreativ Teknologi"}|fancy hologram banner saying "Kultur natt!"|fancy large neon Sign saying "Merry Christmas!"} augmented reality tags. Retain subject\'s identity, proportions, looks and gender  do not change the face and the subject is well lit no hard shadows. Cybernetic enhancements (glowing retinal implants, data-jack ports). Lighting: {acid-rain reflections|neon sign glow|laser grids}. Atmosphere: {gentle rainbows (holographic prisms)|soft snowfall (toxic ash)|sparkling dew (condensation on chrome)|magical sparkles (data corruption artifacts)|colorful fog (smog with RGB pollution)|floating bubbles (energy shields)|stardust showers (falling satellites)|glimmering ice (frozen coolant)|sunset (polluted violet haze)}. Render in high-contrast digital grunge with chromatic aberration and scanlines. holorgaphic christmas colors, holorgraphic chrismas decor',
    "steampunk": 'Christmas card, winter theme where you change style to Textured steampunk with visible rivets, brass patina, grease stains, and functional machinery. Background: {steampunk {Whimsical|crazy|epic|} {Brass|Iron|Glass|Wood} {airballon|airship|Sky Ship|Village|Landscape|City|workshop|hangar}} environment Wearing {Ranger|fantasy|royal guard|white knight|ruffled|Queen|king} attire crafted from worn leather, brass buckles, canvas straps, and clockwork accessories (e.g., riveted armor, gear-embroidered capes, steam-powered prosthetics). add text in a large font in a{Speech bubble saying {"Happy Holiday!!"|"Merry Christmas!"}|fancy banner saying "God Jul!"|fancy large Sign saying "God Jul!"} made of engraved brass plates, typewriter-stamped metal, or flickering neon tubes. Retain subject\'s identity, proportions, looks, and gender. Goggles or monocles with magnifying lenses. Render in Victorian industrial steampunk style with functional, weathered details. Christmas colored decor, christmas colored attire, frozen metal, snow',
    "voxel": 'Christmas card, winter theme where you Change style to Blocky voxel art with 16x16 pixel textures, visible cube edges, and no curved surfaces. Background: {{Whimsical|Cozy|Fun|}  {Castle|Village|Forest|vulcano|Landscape|City}} environment built from Minecraft-style blocks Clothes: {forest ranger|fantasy|royal guard|white knight|ruffled|Fairy|Queen|king|{diamond|gold|iron}armour, robe} attire designed with blocky pixelated patterns, and simple color blocking. Text: {Speech bubble saying {"Happy Holiday!!"|"Merry Christmas!"}|fancy banner saying "x-Mas!"|fancy large Sign saying "God Jul!"} Retain subject\'s identity, proportions, looks, and gender but make them low poly. Blocky facial features (square eyes, flat nose). Day/night cycle lighting with block-based shadows. Render in low-poly voxel style soft light 3d',
    "pixel art": 'Christmas card, winter theme where you Change the style to Retro pixel art with {8-bit|16-bit|32-bit} resolution, visible pixels, no anti-aliasing, and limited color palettes. Background: {{Whimsical|Cozy|Fun|} {Clay|Wood|Stone|Glass} {Castle|Village|Forest|Landscape|City}} environment rendered in tile-based graphics Clothes: {forest ranger|fantasy|royal guard|white knight|ruffled|Fairy|Queen|king} attire designed with color-blocking, sprite patterns, and limited-detail accessories Text: {Speech bubble saying {"Merry Christmas!!"}|fancy banner saying "X-Mas!"|fancy large Sign saying "God Jul!"} in bitmap fonts (e.g., 8x8px pixel font) on {pixelated signs|dithered banners|CRT-screen overlays}. Retain subject\'s identity, proportions, looks, and gender. Dot eyes or simple 2-pixel expressions. Lighting: {global illumination|directional shadows|palette-cycling glows}. Atmosphere: {gentle rainbows (color-band gradients)|soft snowfall (1-pixel flakes)|sparkling dew (single-pixel glints)|magical sparkles (particle sprites)|colorful fog (dithered transparency)|floating bubbles (3x3px circles)|stardust showers (star-shaped sprites)|glimmering ice (crystal tiles)|sunset (dithered sky gradient)}. Render in authentic pixel art style** with visible grid lines and no smooth curves.',
    "watercolor": 'Christmas card, winter theme where you Change the style to Flowing watercolor with translucent washes, pigment granulation, and paper texture. Background: {{Whimsical|Cozy|Fun|} {Clay|Wood|Stone|Glass} {Castle|Village|Forest|Landscape|City}} environment rendered in soft bleeds, wet-on-wet blends, and salt-textured effects (e.g., cloud-like skies, diffused foliage, blurred horizons). Clothes: {forest ranger|fantasy|royal guard|white knight|ruffled|Fairy|Queen|king} attire depicted with transparent layers, color blooms, and ink outlines (e.g., water-soluble pencil details, pigment pooling in fabric folds). Retain subject\'s identity, proportions, looks, and gender. Soft-focus features with expressive watercolor eyes. Lighting: {diffused daylight|moonlit washes|backlit silhouettes}. Atmosphere: {gentle rainbows (prism refraction)|soft snowfall (masked splatters)|sparkling dew (salt textures)|magical sparkles (iridescent mica)|colorful fog (lifted pigment)|floating bubbles (soap-resist)|stardust showers (gold leaf)|glimmering ice (frosted washes)|sunset (variegated wash)}. Render on rough cold-press paper with visible brush strokes and unpainted white space., text saying God Jul! in gold, christmas pattern clothes, warm colors',
    "disney": 'Christmas card, winter theme where you Change the style to disney stylized 3D style and background to {{Whimsical|Cozy|Fun|Magical|winter} {Wizzards christmas|Fairy christmas|Candy christmas|Toy christmas|Giants christmas|Midgets christmas|Mermaid christmas|Troll christmas} {Castle christmas|Village christmas|Forest christmas|Landscape christmas|fantasy christmas Place}} environment and change the clothes to {forest ranger|fantasy|royal guard|pirate|white knight|ruffled|Mermaid|Fairy|queen|king} attire, add text in a large font in a {Speech bubble saying {"Happy Holiday!!"|"Merry Christmas!"|"Kreativ Teknologi"}|fancy banner saying"X-Mas!" in the background|fancy large Sign saying"God Jul!" in the background}, retain subjects identity, porportions, looks and gender. with a atmosphere that has{gentle rainbows|soft snowfall|sparkling dew|magical sparkles|colorful fog|floating bubbles|stardust showers|glimmering ice|sunset}, big eyes, soft light, render'
}
